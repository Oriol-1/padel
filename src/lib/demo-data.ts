...
export const demoPlayers: Player[] = [
  ...
  { id: "demo-player-jordi", firstName: "Jordi", lastName: "Roca", phone: "+34600111004", email: "jordi@example.com", category: "Liga A", level: "Intermedio", active: true, whatsappConsent: false, consentTextVersion: null, consentedAt: null, createdAt: new Date(now - 20 * day), updatedAt: new Date(now - 20 * day) }
];
