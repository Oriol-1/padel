  ...
  return <main className="page"><div className="container">
    ...
    <form action={`/api/admin/events/${id}`} method="post" className="card form-card">
      ...
      <fieldset className="form-section"><legend><span className="form-section-title">2. Fecha y pista</span></legend><div className="form-grid">
        ...
        <details className="advanced-options field-full"><summary>Información adicional{event.address || event.category || event.priceNote || event.description ? " · configurada" : ""}</summary><div className="form-grid details-content">
