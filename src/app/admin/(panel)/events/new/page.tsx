...
export default async function NewEventPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <main className="page"><div className="container"><h1>Nueva convocatoria</h1><p className="muted">Selecciona los jugadores que recibirán el enlace personal.</p>
