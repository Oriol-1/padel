...
export default async function PlayersPage({ searchParams }: { searchParams: Promise<{ created?: string; archived?: string; restored?: string; accessRevoked?: string; error?: string }> }) {
  ...
  return <main className="page"><div className="container">
    ...
    <section className="roster-section"><div className="section-heading"><div><h2>Plantilla activa</h2><p className="muted">Jugadores disponibles para nuevas convocatorias.</p></div><span className="section-count">{active.length}</span></div>
      <div className="table-wrap"><table className="responsive-table"><caption className="sr-only">Jugadores activos</caption><thead><tr><th scope="col">Jugador</th><th scope="col">Contacto</th><th scope="col">Grupo y nivel</th><th scope="col">WhatsApp</th><th scope="col"><span className="sr-only">Acciones</span></th></tr></thead><tbody>
    ...
    <details className="discarded-section" open={discarded.length > 0}>
      ...
      <div className="table-wrap"><table className="responsive-table"><caption className="sr-only">Jugadores archivados</caption><thead><tr><th scope="col">Jugador</th><th scope="col">Contacto</th><th scope="col">Último grupo</th><th scope="col"><span className="sr-only">Acciones</span></th></tr></thead><tbody>
